...
h1.style.background=`rgb(54,126,128)`
h1.style.color=`rgb(246,249,99)`
h1.style.padding=`1rem`
document.querySelector(`body`).style.backgroundColor=`rgb(253,245,231)`
...
books.forEach((book)=>{
    ...
    btn.style.backgroundColor=`rgb(54,126,128)`
    ...
    article.style.width=`29%`
    
    article.style.alignItems=`middel`
