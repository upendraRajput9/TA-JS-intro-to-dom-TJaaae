...
let image = document.querySelectorAll(`img`).length
console.log(`The total number of img element is ${image}`)
...
topics.querySelector(`li`).innerText=`This is the first child element`
